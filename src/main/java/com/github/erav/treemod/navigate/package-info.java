 ...
 * <p>
 * {@link com.github.erav.treemod.navigate.TreeNavigator} only navigates through branches corresponding
 * to user-specified paths. For each path, the navigation starts at the root and moves down the branch.
 * <p>
 * The {@link com.github.erav.treemod.navigate.TreeNavigator} accepts a
 * {@link com.github.erav.treemod.navigate.NavigateAction} and provides callback hooks at each significant
 * step which the {@link com.github.erav.treemod.navigate.NavigateAction} may use to process
 * the nodes.
 * <p>
